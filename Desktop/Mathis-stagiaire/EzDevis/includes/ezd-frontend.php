...
border-radius: 6px;
display: inline-block;">Envoyez</button></center>
 <br/> <br/>
    </fieldset>
        </form>
    </div>
...
$message = "Entreprise :" . $_POST['form_e_name'].
"Secteur d'activité: " . $_POST['form_secteur_activ'].
"Poste: " . $_POST['form_post'].
"Numéro: " . $_POST['form_num_tel'].
"Site Web: " . $_POST['form_site_web'].
"Nombre d'url: " . $_POST['form_nb_url'].
"Nombre de magasin: " .$_POST['form_nb_magasin'].
"option stock: ". $_POST['form_opt_stock'].
"option campub: " .$_POST['form_opt_campub'].
"option trend: " .$_POST['form_opt_trend'].
"option new: " .$_POST['form_opt_new'];
$to = "opusopusmathis@gmail.com";
$headers = array('Content-Type: text/html; charset=UTF-8');
    if(mail($to, $subject, $message, $headers))
    {

      echo "Votre Devis à bien été envoyé nos équipes reprendront contact avec vous dans les plus brefs délais ";
    }
else
{

  echo "Un problème est survenu lors de l'envoi du mail veuillez réessayer";
}
